...
from ..schemas.daily_log import TrackerCreate, FoodData, HydrationUpdate, DailyLogResponse
...
def update_hydration(update: HydrationUpdate, db: Session = Depends(get_db)):
    return tracker_service.update_hydration(db, update)
